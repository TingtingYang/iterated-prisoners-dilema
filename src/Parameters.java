...
*******************************************************************************/
	...
	public static int numParameters;
	...
	public static int nonCodingRegion;

	public static int theirStrategy;
	public static int myStrategy;
	public static int numsteps = 25;	
...
*******************************************************************************/
	...
	public Parameters(String parmfilename) throws java.io.IOException{
		...
		nonCodingRegion = Integer.parseInt(parmInput.readLine().substring(30).trim());

		myStrategy = Integer.parseInt(parmInput.readLine().substring(30).trim());
		theirStrategy = Integer.parseInt(parmInput.readLine().substring(30).trim());
...
*******************************************************************************/
	...
	public static void outputParameters(FileWriter output) throws java.io.IOException{
		...
		output.write("Size of Non-Coding Region    :  " + nonCodingRegion + "\n");
