...
public class microBoost extends Strategy
{
	...
	public int nextMove() {
		...
		double weightedSum= 0;												//used for selection
		int currentMove = 0;											//create random play if no strategy is decent
...
*/		
		...
		randomNumber = weightedSum*r.nextDouble();
		rWheel = 0;
		for(int i = 0; i < weightedValues.size(); i++){
			rWheel = rWheel + weightedValues.get(i);			
