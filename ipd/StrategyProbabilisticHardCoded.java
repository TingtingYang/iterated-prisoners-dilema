...
public class StrategyProbabilisticHardCoded extends Strategy
{
	/**
	...
	public StrategyProbabilisticHardCoded()
	{
		name = "Probabilistic_HardCoded";

		opponentMoves = new ArrayList<Integer>();
		playerMoves = new ArrayList<Integer>();
		
		playerMoveData = "011110010000110101001100010101010101001010001";
